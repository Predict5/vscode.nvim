...
theme.set_highlights = function(opts)
    ...
    hl(0, 'LineNr', { fg = c.vscLineNumber, bg = 'NONE' })
    ...
    hl(0, 'Comment', { fg = c.vscLightGray, bg = 'NONE', italic = opts.italic_comments })
    hl(0, 'Constant', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, 'String', { fg = c.vscPeach, bg = 'NONE' })
    hl(0, 'Character', { fg = c.vscPeach, bg = 'NONE' })
    ...
    hl(0, 'Function', { fg = c.vscBrightYellow, bg = 'NONE' })
    ...
    -- c#
    hl(0, '@Lsp.Type.Class', { fg = c.vscLighterGreen, bg = 'NONE' })
